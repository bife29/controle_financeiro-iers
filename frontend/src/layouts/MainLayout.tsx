...
const navigation = [
  ...
  { name: 'Compras', href: '/compras', icon: ShoppingCart, roles: ['super_admin', 'pastor', 'financeiro', 'secretaria'] },
  { name: 'Relatórios', href: '/relatorios', icon: FileBarChart, roles: ['super_admin', 'pastor', 'financeiro'] },
